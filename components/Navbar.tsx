...
export default function Navbar({ className }: NavbarProps) { 
    ...
    return (
        <div className="flex w-screen items-center justify-center top-0">
            ...
            {toggle && 
            <div className='flex flex-col absolute top-25 container gap-5 text-lg p-3 divide-y font-medium divide-paleta-konnectai-terciary bg-paleta-konnectai-primary text-paleta-konnectai-terciary h-auto'>
