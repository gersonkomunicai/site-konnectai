...
export default function Navbar({ className }: NavbarProps) {
    ...
    return (
        <div className="flex w-screen items-center justify-center top-0">
            <div className={`hidden lg:flex fixed ${visible ? 'transition-transform translate-y-0 bg-paleta-konnectai-fifth/80' : 'transition-transform -translate-y-full'} container items-center justify-between lg:p-4 h-25 ${className}`}>
                <div>
                    <a href="/">
            ...
            <div className={`lg:hidden flex container fixed bg-paleta-konnectai-fifth left-0 md:left-auto items-center justify-between p-4 h-25 ${className}`}>
                <a href="/">
            ...
            {toggle &&
                <div className='flex flex-col fixed left-0 md:left-auto top-25 container gap-5 text-lg p-3 divide-y font-medium divide-paleta-konnectai-terciary bg-paleta-konnectai-fifth text-paleta-konnectai-terciary h-auto'>
                    <a href="/produtos" className='navbarHover'>Produtos</a>
                    <a href="/canais" className='navbarHover'>Canais</a>
                    <a href="/quem-somos" className='navbarHover'>Quem somos</a>
                    {/* <a href="" className='navbarHover'>Blog</a> */}
