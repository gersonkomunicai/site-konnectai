...
export default function Navbar({ className }: NavbarProps) { 
    ...
    return (
        <div className="flex w-screen items-center justify-center top-0">
            ...
            <div className={`lg:hidden flex container left-0 items-center justify-between p-4 h-25 ${className}`}>
            ...
            {toggle && 
            <div className='flex flex-col absolute left-0 top-25 container gap-5 text-lg p-3 divide-y font-medium divide-paleta-konnectai-terciary bg-paleta-konnectai-primary text-paleta-konnectai-terciary h-auto'>
                <a href="" className='navbarHover'>Produtos</a>
                <a href="" className='navbarHover'>Canais</a>
                <a href="" className='navbarHover'>Quem somos</a>
                <a href="" className='navbarHover'>Blog</a>
                <a href="" className='navbarHover'>Contato</a>
                <a href="" className='navbarHover'>Fale com um especialista</a>
